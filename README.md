...
- Gold coins appear in traffic lanes and load up to three grenade shots. B/Space, double-tap, or FIRE disables a vehicle for +25 points; wrecked vehicles stop being deadly until they scroll off-screen.
...
Gold coins appear briefly on road lanes. Collect one to load a shot, then press **B** or **Space** on desktop, or double-tap/tap **FIRE** on mobile, to launch a grenade. A hit disables that vehicle and awards 25 points.
